...
class LangGame extends Component {
  constructor(props) {
    super(props);

    this.state = {
      AppMode: "", // NoAction, Game, PlayerWin, AIWin
      MoveState: "",
  ...
  render = () => {
    ...
    return (
      <div className="CardTable">
        <img ref="LangLogo" className="LogoImage" src={LangLogo} alt="deck" />

        <div className="CardTableHeader">
          <div className="HeaderText"> Team 1 ({AICardCount}) </div>
          <button
            className="LangGameButton HeaderText"
          ...
          <div className="HeaderText"> Team 2 ({PlayerCardCount}) </div>
        </div>
